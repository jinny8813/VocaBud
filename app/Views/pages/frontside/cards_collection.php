    ...
    <div class="container-fluid bg_green">
        <div class="row justify-content-center">
            <div class="col-md-8 row justify-content-center align-items-center">
                ...
                <div class="col-8 p-3">
                    <div class="fs-3 text-center">我的字卡</div>
                </div>
                <div class="col-2">
                </div>
            </div>
                ...
                <div class="card mb-3">
                    <div class="row g-0">
                        ...
                        <div class="col-9 card-body">
                            <div class="fs-5">
                                <strong><a href="<?= base_url('cards_list/'."allofmine")?>" class="a_black stretched-link">所有字卡</a></strong>
                            </div>
                            <div><i class="fa-fw fa-solid fa-swatchbook"></i> <?= $cards?></div>
                        </div>
                    </div>
                </div>
